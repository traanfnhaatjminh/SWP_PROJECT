 ...
 * @author nguye
 */
@WebServlet(name = "DetailOrderForSaleServlet", urlPatterns = {"/detailOrderForSaleServlet"})
public class DetailOrderForSaleServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DetailOrderForSaleServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
