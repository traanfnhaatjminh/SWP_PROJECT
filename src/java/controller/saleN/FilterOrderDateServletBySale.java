 ...
 * @author nguye
 */
@WebServlet(name = "FilterOrderDateServletBySale", urlPatterns = {"/FilterOrderDateServletBySale"})
public class FilterOrderDateServletBySale extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            listOrders = dao.getOrdersByDateRangeBySale(sId, startDateStr, endDateStr);                             
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FilterOrderDateServletBySale.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
